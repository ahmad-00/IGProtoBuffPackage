...
extension IGPClientRoomReport.IGPReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [IGPClientRoomReport.IGPReason] = [
    .other,
    .spam,
    .pornography,
    .violence,
...
extension IGPClientRoomReport: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: IGPClientRoomReport, rhs: IGPClientRoomReport) -> Bool {
...
extension IGPClientRoomReportResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: IGPClientRoomReportResponse, rhs: IGPClientRoomReportResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
