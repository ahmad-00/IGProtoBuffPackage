...
extension IGPUserIVandGetActivities: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: IGPUserIVandGetActivities, rhs: IGPUserIVandGetActivities) -> Bool {
...
extension IGPUserIVandGetActivitiesResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: IGPUserIVandGetActivitiesResponse, rhs: IGPUserIVandGetActivitiesResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._igpResponse != rhs_storage._igpResponse {return false}
        if _storage._igpActivities != rhs_storage._igpActivities {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
